...
models_directory = os.path.split(current_file_path)[0] + "/models/"
...
if __name__ == "__main__":
    ...
    def main(argv):
        ...
        try:
            ...
            print('main.py -d 2 -l 5 -t 5 -o output')
            sys.exit(2)
        for opt, arg in opts:
            if opt == '-h':
                print('main.py -d <depth> -l <lenght of rows> -t <total texts> -o <output-filename>')
                sys.exit()
            elif opt in ("-d", "--depth"):
